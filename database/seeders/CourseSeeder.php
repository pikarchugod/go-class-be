...
class CourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $courses = [
            ['title' => 'Laravel 初學指南', 'description' => '適合新手學習 Laravel', 'price' => 2000],
            ['title' => '進階 Vue.js 開發', 'description' => '學習 Vue.js 深入應用', 'price' => 3000],
            ['title' => 'Python 資料科學入門', 'description' => '掌握 Pandas 與 Numpy', 'price' => 4000],
            ['title' => '前端基礎 CSS + JS', 'description' => '學習網頁前端開發基礎', 'price' => 5000],
            ['title' => '進階 AI 機器學習', 'description' => '學習機器學習算法', 'price' => 6000],
        ];
